...
public class ModelFactory {
    ...
    public static Note getNote(@Nullable Notebook notebook, @Nullable Category category) {
        ...
        if (category != null) {
            note.setTags(getCategoriesString(Collections.singletonList(category)));
        }
    ...
    public static String getCategoriesString(List<Category> categories) {
        ...
        for (int i=0; i<len; i++) {
            ...
            if (i != len - 1) {
                sb.append(DBConfig.CATEGORY_SPLIT);
            }
        }
